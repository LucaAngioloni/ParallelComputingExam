...
java_comand = "java -classpath ../Histogram_Equalization_\(mid-term\)/Code/HistogramEQParallel/out/production/HistogramEQParallel:../Histogram_Equalization_\(mid-term\)/Code/HistogramEQParallel/commons-cli-1.3.1.jar it.LucaAngioloni.Main -json"
